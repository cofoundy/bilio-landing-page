    ...
    <section id="how-it-works" className="py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          {/* Modified connecting line to ensure it doesn't interfere with content */}
          <div className="hidden lg:block absolute top-1/2 left-[10%] right-[10%] h-1 bg-gradient-to-r from-spendly-blue via-spendly-purple to-spendly-pink transform -translate-y-1/2 z-0 opacity-50"></div>
          
          <div className="grid md:grid-cols-3 gap-8 relative z-10">
            {steps.map((step, index) => (
              <div key={step.id} className="step-card bg-white animate-slide-up" style={{ animationDelay: `${index * 0.2}s` }}>
