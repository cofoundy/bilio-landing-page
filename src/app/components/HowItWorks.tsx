      ...
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
          ...
          {steps.map((step, i) => (
            <div
              key={step.number}
              className="glass-card rounded-[20px] px-7 py-8 relative z-[1] transition-all duration-300 text-center hover:bg-bilio-surface-hover hover:border-bilio-border-gold hover:-translate-y-1 hover:shadow-[0_20px_50px_rgba(0,0,0,0.35)]"
            >
              {/* Step number circle */}
